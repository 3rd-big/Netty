...
public class HttpsServerHandler extends SimpleChannelInboundHandler<Object> {
...
//            System.out.println("responseData.setLength(0): " + responseData.toString());
            System.out.println("request: " + request.toString());
//            System.out.println("msg: " + msg.toString());
            responseData.append(RequestUtils.formatParams(request));
//            System.out.println("responseData.append(RequestUtils.formatParams(request)) ¿Ã»ƒ: " + responseData.toString());
        }

        responseData.append(RequestUtils.evaluateDecoderResult(request));
//        System.out.println("responseData.append(RequestUtils.evaluateDecoderResult(request1)): " + responseData.toString());
...
//            System.out.println("msg instanceof HttpContent");
            ...
            responseData.append(RequestUtils.evaluateDecoderResult(request));
//            System.out.println("responseData.append(RequestUtils.evaluateDecoderResult(request2)): " + responseData.toString());

            if (msg instanceof LastHttpContent) {
//            	System.out.println("msg instanceof LastHttpContent");
